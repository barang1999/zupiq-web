    ...
    <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 px-8 max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center overflow-visible">
      ...
      >
        ...
        <div className="relative w-72 h-72 lg:w-96 lg:h-96 rounded-full bg-primary-container flex items-center justify-center shadow-[0_0_100px_rgba(0,244,254,0.4)]">
          <div className="absolute inset-0 rounded-full border-[12px] border-white/20 blur-sm"></div>
          <img 
            className="w-full h-full object-cover rounded-full mix-blend-overlay" 
            src="https://lh3.googleusercontent.com/aida-public/AB6AXuAjPDGGng8qRIZQesZj9m3TCvW8Widbi63XN86knWfemKXHKKHKdv6BZcotFxdUl2srQSQTE5nNVPezXBHf666GffO9vgGGPBh3nvx0Kj02mg4_FOje4LDxT0gDNPBEfqP8hyFtNMKpbFhXvDgCTapZabemx_fNLH77APX8_r84TgPv0FsnYSigEkVmN_elVYdZxs8Bf3Rfzkp3Tem2dGLTCGkONs8TYDpcfMwlxhj7ELxO2QHYDM6tva09m1DVSwXN1mxEjTEe0a0" 
            alt="Abstract AI Prism"
            referrerPolicy="no-referrer"
          />
          <motion.div 
            animate={{ opacity: [0.3, 0.6, 0.3] }}
            transition={{ duration: 3, repeat: Infinity }}
            className="absolute w-full h-full rounded-full bg-gradient-to-tr from-primary/40 to-secondary/40"
          ></motion.div>
          ...
          <motion.div 
            ...
            className="absolute -top-4 -right-4 w-20 h-20 glass-card rounded-xl rotate-12 flex items-center justify-center border border-white/10"
          >
          ...
          <motion.div 
            ...
            className="absolute -bottom-6 left-10 w-16 h-16 glass-card rounded-full -rotate-12 flex items-center justify-center border border-white/10"
          >
