      ...
      <motion.div initial={{ opacity: 0, scale: 0.8 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ duration: 1 }} className="relative flex justify-center items-center">
        <div className="relative w-full max-w-lg aspect-square flex items-center justify-center">
          <svg className="w-full h-full drop-shadow-[0_0_30px_rgba(0,245,255,0.2)]" viewBox="0 0 400 400" xmlns="http://www.w3.org/2000/svg">
            ...
            <g stroke="#00F5FF">
              <path pathLength={1} className="neural-link" d="M200 380 L200 300" style={{ animationDelay: "0.2s", animationDuration: "0.6s", strokeWidth: 3 }} />
              <path pathLength={1} className="neural-link" d="M200 300 L140 240" style={{ animationDelay: "0.95s", animationDuration: "0.62s" }} />
              <path pathLength={1} className="neural-link" d="M200 300 L260 240" style={{ animationDelay: "0.95s", animationDuration: "0.62s" }} />
              <path pathLength={1} className="neural-link" d="M140 240 L80 200" style={{ animationDelay: "1.75s", animationDuration: "0.56s", strokeWidth: 1.5 }} />
              <path pathLength={1} className="neural-link" d="M140 240 L160 160" style={{ animationDelay: "1.75s", animationDuration: "0.56s", strokeWidth: 1.5 }} />
              <path pathLength={1} className="neural-link" d="M260 240 L320 200" style={{ animationDelay: "1.75s", animationDuration: "0.56s", strokeWidth: 1.5 }} />
              <path pathLength={1} className="neural-link" d="M260 240 L240 160" style={{ animationDelay: "1.75s", animationDuration: "0.56s", strokeWidth: 1.5 }} />
              <path pathLength={1} className="neural-link" d="M160 160 L120 100" style={{ animationDelay: "2.55s", animationDuration: "0.5s", strokeWidth: 1 }} />
              <path pathLength={1} className="neural-link" d="M160 160 L200 80" style={{ animationDelay: "2.55s", animationDuration: "0.5s", strokeWidth: 1 }} />
              <path pathLength={1} className="neural-link" d="M240 160 L280 100" style={{ animationDelay: "2.55s", animationDuration: "0.5s", strokeWidth: 1 }} />
              <path pathLength={1} className="neural-link" d="M240 160 L220 60" style={{ animationDelay: "2.55s", animationDuration: "0.5s", strokeWidth: 1 }} />
              <path pathLength={1} className="neural-link" d="M80 200 L52 154" style={{ animationDelay: "2.55s", animationDuration: "0.5s", strokeWidth: 0.9 }} />
              <path pathLength={1} className="neural-link" d="M80 200 L92 142" style={{ animationDelay: "2.55s", animationDuration: "0.5s", strokeWidth: 0.9 }} />
              <path pathLength={1} className="neural-link" d="M320 200 L348 154" style={{ animationDelay: "2.55s", animationDuration: "0.5s", strokeWidth: 0.9 }} />
              <path pathLength={1} className="neural-link" d="M320 200 L308 142" style={{ animationDelay: "2.55s", animationDuration: "0.5s", strokeWidth: 0.9 }} />
              <path pathLength={1} className="neural-link" d="M120 100 L92 66" style={{ animationDelay: "3.35s", animationDuration: "0.45s", strokeWidth: 0.85 }} />
              <path pathLength={1} className="neural-link" d="M120 100 L142 58" style={{ animationDelay: "3.35s", animationDuration: "0.45s", strokeWidth: 0.85 }} />
              <path pathLength={1} className="neural-link" d="M280 100 L258 66" style={{ animationDelay: "3.35s", animationDuration: "0.45s", strokeWidth: 0.85 }} />
              <path pathLength={1} className="neural-link" d="M280 100 L308 58" style={{ animationDelay: "3.35s", animationDuration: "0.45s", strokeWidth: 0.85 }} />
              <path pathLength={1} className="neural-link" d="M200 80 L176 48" style={{ animationDelay: "3.35s", animationDuration: "0.45s", strokeWidth: 0.8 }} />
              <path pathLength={1} className="neural-link" d="M200 80 L226 44" style={{ animationDelay: "3.35s", animationDuration: "0.45s", strokeWidth: 0.8 }} />
              <path pathLength={1} className="neural-link" d="M220 60 L200 28" style={{ animationDelay: "3.35s", animationDuration: "0.45s", strokeWidth: 0.8 }} />
              <path pathLength={1} className="neural-link" d="M220 60 L246 34" style={{ animationDelay: "3.35s", animationDuration: "0.45s", strokeWidth: 0.8 }} />
            </g>
