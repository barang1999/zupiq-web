                  ...
                  {recent3.map((session, i) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className={`text-lg sm:text-xl font-bold mb-2 group-hover:${color} transition-colors relative z-10 line-clamp-2`}>
                            ...
                            >
                              <div className="flex items-start justify-between gap-4">
                                <div className="min-w-0">
                                  <div className="font-bold text-on-surface line-clamp-2">
                                    <RichText mode="preview">{toSingleLinePreview(session.title)}</RichText>
                                  </div>
                          ...
                          return (
                            ...
                            >
                              ...
                              <td className="px-8 py-6 font-bold text-on-surface max-w-xs">
                                ...
                                <div className="block text-xs text-on-surface-variant font-normal mt-0.5 line-clamp-1">
                                  <RichText mode="preview">{toSingleLinePreview(session.problem)}</RichText>
                                </div>
                              </td>
