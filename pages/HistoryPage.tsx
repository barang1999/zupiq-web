        ...
        <div className="max-w-7xl mx-auto">
          ...
          <section className="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-8">
            ...
            <div className="flex gap-4 shrink-0">
              <div className="bg-surface-container-highest/40 backdrop-blur-xl p-6 rounded-3xl min-w-[140px] border border-white/5">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <section className="lg:col-span-8">
              <div className="bg-surface-container-low p-8 rounded-[40px] relative overflow-hidden h-full">
                <div className="relative z-10">
                  <div className="flex items-center justify-between mb-10">
                    <div>
                      <h3 className="text-2xl font-headline font-bold text-on-surface">Mastery Trends</h3>
                  ...
                  <div className="w-full h-56 relative">
                    ...
                    <div className="absolute bottom-0 w-full flex justify-between text-[10px] text-on-surface-variant font-label border-t border-outline-variant/20 pt-3">
            ...
            <aside className="lg:col-span-4">
              <div className="bg-surface-container p-8 rounded-[40px] relative border border-white/5 h-full flex flex-col justify-between">
                <div>
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <span className="font-headline font-bold text-xl">Neural Pulse</span>
                  </div>
                ...
                <button
                  onClick={() => onNavigateStudy?.()}
                  className="w-full py-4 rounded-full bg-surface-container-highest border border-outline-variant/30 text-on-surface font-bold hover:bg-surface-bright transition-all"
                >
                  Start New Session
                </button>
              </div>
            ...
            <section className="lg:col-span-12">
              <h3 className="text-2xl font-headline font-bold text-on-surface mb-6">Recent Activity</h3>
              {loading ? (
                  ...
                  {recent3.map((session, i) => {
                    ...
                    return (
                      <motion.div
                        ...
                        className="bg-surface-container-highest/40 backdrop-blur-xl p-6 rounded-[32px] group hover:bg-surface-container transition-all cursor-pointer relative overflow-hidden"
                      >
                        ...
                        <h4 className={`text-xl font-bold mb-2 group-hover:${color} transition-colors relative z-10 line-clamp-2`}>
                          {session.title}
                        </h4>
            ...
            <section className="lg:col-span-12">
              <div className="bg-surface-container-low rounded-[40px] overflow-hidden">
                <div className="p-8 flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-outline-variant/10">
                  <h3 className="text-2xl font-headline font-bold">Detailed History Log</h3>
